...
Your AI tool is now connected to AlloyDB using MCP. Try asking your AI assistant to create database, create cluster and create instance.
...
## Use data Plane tools

Once the database is created you can connect your IDE with Database using data plane tools using: https://cloud.google.com/alloydb/docs/pre-built-tools-with-mcp-toolbox.
