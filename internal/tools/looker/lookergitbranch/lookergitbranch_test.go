...
import (
	...
	lkr "github.com/googleapis/genai-toolbox/internal/tools/looker/lookergitbranch"
)
...
func TestFailParseFromYamlLookerGitBranch(t *testing.T) {
	...
	tcs := []struct {
	...
	}{
		{
            ...
            description: some description
			`,
			err: "error unmarshaling tools: unable to parse tool \"example_tool\" as type \"looker-git-branch\": [3:1] unknown field \"method\"\n   1 | authRequired: []\n   2 | description: some description\n>  3 | method: GOT\n       ^\n   4 | name: example_tool\n   5 | source: my-instance\n   6 | type: looker-git-branch",
		},
	}
	for _, tc := range tcs {
		t.Run(tc.desc, func(t *testing.T) {
